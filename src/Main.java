...
public class Main {
    ...
    public static String parse(String expression) throws Exception {
        ...
        // Если оба фисла арабские
            ...
            //если одночисло римское, а другое арабское
            throw new Exception("Числа должны быть в одном формате.");
        }
        if (num1 > 10 || num2 > 10){
            throw new Exception("Числа дложны быть от одного до десяти.");
        }
    ...
    static class Roman {
        ...
        public static String convertToRoman(int arabian) {
            return Roman.romanArray[arabian];
        }
    }
}